"""
Training script for CNN 32s window model
...
w_len = 16 * fs  # half window size: 16 seconds * 200 Hz = 3200 samples (total window = 32s)
data_dim = w_len * 2  # full window: 6400 samples
half_prec = 0.5
prec = 1
