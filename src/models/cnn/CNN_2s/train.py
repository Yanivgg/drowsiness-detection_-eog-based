"""
Training script for CNN 2s window model
...
w_len = 1 * fs  # half window size: 1 second * 200 Hz = 200 samples (total window = 2s)
data_dim = w_len * 2  # full window: 400 samples
half_prec = 0.5
prec = 1
