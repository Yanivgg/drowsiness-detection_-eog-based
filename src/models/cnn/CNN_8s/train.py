"""
Training script for CNN 8s window model
...
w_len = 4 * fs  # half window size: 4 seconds * 200 Hz = 800 samples (total window = 8s)
data_dim = w_len * 2  # full window: 1600 samples
half_prec = 0.5
prec = 1
